...
def construct_farmer_summary_statistics(base_summary, registrant_data):
    ...
    '''
    land_areas = [farmer.land_area for farmer in registrant_data if farmer.land_area is not None]
...
def construct_student_summary_statistics(base_summary, registrant_data):
    ...
    '''
    students_age = [calculate_age(student.date_of_birth) for student in registrant_data if student.date_of_birth is not None]
    ...
    if students_age:
        ...
        student_summary.age_quartile_25 = float(np.percentile(students_age_array, 25, method="midpoint"))
        student_summary.age_quartile_50 = float(np.percentile(students_age_array, 50, method="midpoint"))
        student_summary.age_quartile_75 = float(np.percentile(students_age_array, 75, method="midpoint"))
